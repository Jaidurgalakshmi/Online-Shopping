...
<body class="container mt-4">
  ...
  <h3 class="fixed-header text-center mb-4">Sarees Collection <a href="Cart.jsp" class="btn btn-success go-to-cart" style="float:right">Go to Cart 🛒</a></h3>
  
<div class="row mt-5 pt-5" id="saree-row"></div>
  <script>
